    ...
    <div class="sidebar-wrapper active">
        <div class="sidebar-header position-relative">
            <div class="d-flex justify-content-between align-items-center">
                <div class="logo">
                    <a href="index.html"><img src="{{ asset('/') }}assets/dist/compiled/svg/logo.svg" alt="Logo"
                            srcset=""></a>
                </div>
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item has-sub {{ request()->is('pengalaman_kerja', 'pengalaman_kerja/*','pendidikan', 'pendidikan/*') ? 'active' : '' }}">
                    ...
                    <ul class="submenu ">
                        ...
                        <li class="submenu-item {{ request()->is('pengalaman_kerja', 'pengalaman_kerja/*') ? 'active' : '' }} ">
                            <a href="{{ url('pengalaman_kerja') }}" class="submenu-link">Pengalaman Kerja</a>

                        </li>

                        <li class="submenu-item {{ request()->is('pendidikan', 'pendidikan/*') ? 'active' : '' }} ">
                            <a href="{{ url('pendidikan') }}" class="submenu-link">Pendidikan</a>
                ...
                {{-- <li class="sidebar-item  has-sub">
                    ...
                    <ul class="submenu ">
                        ...
                        <li class="submenu-item  ">
                            <a href="component-accordion.html" class="submenu-link">Pendidikan</a>

                        </li>

                        <li class="submenu-item  ">
                            <a href="component-alert.html" class="submenu-link">Pengalaman Kerja</a>
